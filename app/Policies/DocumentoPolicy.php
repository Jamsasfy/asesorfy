...
class DocumentoPolicy
{
    ...
    {
        return $user->can('view_documento');
    }
    ...
    {
        return $user->can('create_documento');
    }
    ...
    {
        return $user->can('update_documento');
    }
    ...
    {
        return $user->can('delete_documento');
    }
    ...
    {
        return $user->can('delete_any_documento');
    }
